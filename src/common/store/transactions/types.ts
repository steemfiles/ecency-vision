...
export interface TokensDelegate extends HECoarseBaseTransaction {
    operation: "tokens_delegate";
    account: string;
    quantity: string;
    to: string;
}
export interface TokensUnDelegateDone extends HECoarseBaseTransaction {
    operation: "tokens_undelegateDone";
    account: string;
}
...
export type HECoarseTransaction = HETokensIssue | HEUnstakeStart | HETokensTransfer
    | HETokensCancelUnstake | HEMarketSell | HEMarketPlaceOrder
    | HEMarketCancel | HETokensUndelegateDone | TokensDelegate
    | TokensUnDelegateDone | HEMarketBuy | HEMarketPlaceOrder | HETokensUndelegateStart | HETokensStake | HECancelUnstake;
