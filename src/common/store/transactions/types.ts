...
export type HECoarseTransaction = HETokensIssue | HEUnstakeStart
	| HETokensTransfer | HETokensCancelUnstake
	| HEMarketSell | HEMarketBuy | HEMarketPlaceOrder
	| HEMarketCancel | HETokensUndelegateDone | HETokensDelegate
	| HETokensUndelegateDone | HEMarketBuy | HEMarketPlaceOrder
	| HETokensUndelegateStart | HETokensStake | HECancelUnstake
	| HEMarketCancel;
